...
download.file(fileURL, destfile = "/data", 
              #created /data as subdirectory of current wd, but trying to write to ./data, which doesn't exist
              method = "curl")
        # didn't unzip file --ams
        

# read files into R 

# hardcoded paths here should probably be replaced by variables --ams
